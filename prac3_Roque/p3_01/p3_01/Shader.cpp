...
void Shader::CompileShader(const char* vertexCode, const char* fragmentCode)
{
	...
	//**********************
	uniformc1 = glGetUniformLocation(shaderID, "c1");
	uniformc2 = glGetUniformLocation(shaderID, "c2");

}
//*****************************
//**para actualizar el shader
...
GLuint Shader::getc2Location()
{
	return uniformc2;
}
GLuint Shader::getc1Location()
{
	return uniformc1;
}
