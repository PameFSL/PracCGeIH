...
//	Assimp::Importer importer = Assimp::Importer();
	...
	while (!mainWindow.getShouldClose())
	{
		...
		modelCoche = model = glm::rotate(model, giro1 * toRadians, glm::vec3(0.0f, 0.0f, 1.0f));
