...
std::vector<Shader1> shaderList1;
Camera camera;
...
void CreateShaders()
{
	...
	Shader1 *shader2 = new Shader1();
	shader2->CreateFromFiles1(vShader1, fShader1);
	shaderList1.push_back(*shader2);
}
...
//contador de luces puntuales
	...
	//**************************************
	GLuint uniformProjection1 = 0, uniformModel1 = 0, uniformView1 = 0;
	//*************************
	...
	while (!mainWindow.getShouldClose())
	{
		...
		shaderList[0].UseShader();
		uniformModel1 = shaderList1[0].getModelLoaction1();
		uniformProjection1 = shaderList1[0].getProjectLocation1();
		uniformView1 = shaderList1[0].getViewLocation1();
		//*************************************
	...
	//************* esfera ****************
		...
		glUniformMatrix4fv(uniformModel1, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
